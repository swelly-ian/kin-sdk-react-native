...
+ (void)sendInvoicedPayment:(NSString * _Nonnull)env :(NSDictionary * _Nonnull)request :(void (^ _Nonnull)(NSMutableDictionary * _Nonnull))resolve :(void (^ _Nonnull)(NSString * _Nonnull, NSString * _Nonnull, NSError * _Nonnull))reject;
